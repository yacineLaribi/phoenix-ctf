...
class UserContent(models.Model):
	author = models.ForeignKey(ScrumUser,on_delete=models.CASCADE)
...
class Vote(models.Model):
	content = models.ForeignKey(UserContent,on_delete=models.CASCADE)
	voter = models.ForeignKey(ScrumUser,on_delete=models.CASCADE)
